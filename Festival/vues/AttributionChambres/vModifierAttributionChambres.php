<?php
  ...
  $nbEtabOffrantChambres = EtablissementDAO:: obtenirNbEtabOffrantChambres($connexion);
  ...
  $rsEtab = EtablissementDAO:: obtenirNomEtablissementsOffrantChambres($connexion);
  ...
  $rsEtab = EtablissementDAO:: obtenirIdEtablissementsOffrantChambres($connexion);
  ...
  $rsGroupe = GroupeDAO:: obtenirIdNomGroupesAHeberger($connexion);
      ...
      while ($lgEtab =  $rsEtab->fetch(PDO::FETCH_ASSOC)) {
          ...
          while ($lgTypeChambre = $rsTypeChambre->fetch(PDO::FETCH_ASSOC)) {
              ...
              if ($nbOffre == 0) {
                  ...
                  $nbOccupGroupe =  AttributionDAO:: obtenirNbOccupGroupe($connexion, $idEtab, $idTypeChambre, $idGroupe);
                  if ($nbOccupGroupe != 0) {
