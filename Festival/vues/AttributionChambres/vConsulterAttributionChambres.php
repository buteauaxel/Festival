<?php
    ...
    if ($_SESSION ['nom'] != 'invité') {
        ...
        $nbEtabOffrantChambres = EtablissementDAO:: obtenirNbEtab ($connexion);
        if ($nbEtabOffrantChambres != 0) {
           ...
           Effectuer ou modifier les attributions</a> <br> <br>";
            ...
            $rsEtab = EtablissementDAO:: obtenirIdNomEtablissementsOffrantChambres ($connexion);

            $nbTypesChambres = TypeChambreDAO:: obtenirNbTypesChambres($connexion);
            // Détermination du :
            ...
            while ($lgEtab = $rsEtab->fetch(PDO::FETCH_ASSOC)) {
              ...
              <table width='70%' cellspacing='0' cellpadding='0' class='tabQuadrille'>";
                ...
                $rsTypeChambre = TypeChambreDAO:: obtenirTypesChambres ($connexion);
                ...
                while ($lgTypeChambre = $rsTypeChambre->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $nbChDispo = AttributionDAO:: obtenirNbDispo ($connexion, $idEtab, $idTypeChambre);
                ...
                $rsGroupe = AttributionDAO:: obtenirGroupesEtab ($connexion, $idEtab);
                ...
                while ($lgGroupe = $rsGroupe->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $rsTypeChambre = TypeChambreDAO:: obtenirIdTypesChambres($connexion);
                    ...
                    while ($lgTypeChambre = $rsTypeChambre->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $nbOccupGroupe = AttributionDAO:: obtenirNbOccupGroupe($connexion, $idEtab, $lgTypeChambre["id"], $idGroupe);
                        echo "
